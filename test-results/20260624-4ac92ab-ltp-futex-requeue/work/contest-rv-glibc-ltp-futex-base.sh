...
if [[ -x ./fork_procs ]]; then if run_ltp_bounded_case fork_procs; then (( pass++ )); else (( fail++ )); fi; else print "FAIL LTP CASE fork_procs : missing"; (( fail++ )); fi
if [[ -x ./ftest01 ]]; then if run_ltp_bounded_case ftest01; then (( pass++ )); else (( fail++ )); fi; else print "FAIL LTP CASE ftest01 : missing"; (( fail++ )); fi
if [[ -x ./ftest02 ]]; then if run_ltp_bounded_case ftest02; then (( pass++ )); else (( fail++ )); fi; else print "FAIL LTP CASE ftest02 : missing"; (( fail++ )); fi
if [[ -x ./ftest03 ]]; then if run_ltp_bounded_case ftest03; then (( pass++ )); else (( fail++ )); fi; else print "FAIL LTP CASE ftest03 : missing"; (( fail++ )); fi
if [[ -x ./ftest04 ]]; then if run_ltp_bounded_case ftest04; then (( pass++ )); else (( fail++ )); fi; else print "FAIL LTP CASE ftest04 : missing"; (( fail++ )); fi
if [[ -x ./ftest05 ]]; then if run_ltp_bounded_case ftest05; then (( pass++ )); else (( fail++ )); fi; else print "FAIL LTP CASE ftest05 : missing"; (( fail++ )); fi
if [[ -x ./ftest06 ]]; then if run_ltp_bounded_case ftest06; then (( pass++ )); else (( fail++ )); fi; else print "FAIL LTP CASE ftest06 : missing"; (( fail++ )); fi
if [[ -x ./ftest07 ]]; then if run_ltp_bounded_case ftest07; then (( pass++ )); else (( fail++ )); fi; else print "FAIL LTP CASE ftest07 : missing"; (( fail++ )); fi
if [[ -x ./ftest08 ]]; then if run_ltp_bounded_case ftest08; then (( pass++ )); else (( fail++ )); fi; else print "FAIL LTP CASE ftest08 : missing"; (( fail++ )); fi
